...
public class c5_CreatingSequence {
    ...
    public void interval() {
        Flux<Long> interval = Flux.interval(Duration.ofSeconds(1L));//todo: change this line only
    ...
    public void repeat() {
        ...
        Flux<Integer> repeated = Mono.fromCallable(()-> {return counter.addAndGet(1);}).repeat(9); //todo: change this line
