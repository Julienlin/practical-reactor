...
/**
 * Sequence may produce many elements, but we are not always interested in all
 * of them. In this chapter we will learn
...
public class c3_FilteringSequence extends FilteringSequenceBase {
         ...
         * Without using `filter()` operator, collect only objects that are instance of
         * `String`
         */
        @Test
        ...
        /**
         * This service may return duplicated data. Filter out all the duplicates from
         * the sequence.
         */
        @Test
        ...
        /**
         * This service returns many elements, but you are only interested in the first
         * one.
         * Also, service is very fragile, if you pull more than needed, you may brake
         * it.
         *
        ...
        /**
         * `number_service()` returns 300 numbers, but you only need 100 numbers, from
         * the middle.
         */
        @Test
