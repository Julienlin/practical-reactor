...
public class c7_ErrorHandling extends ErrorHandlingBase {
        ...
        /**
         * You are monitoring hearth beat signal from space probe. Heart beat is sent
         * every 1 second.
        ...
        public void have_a_backup() {
                ...
                Flux<String> messages = messageNode().onErrorResume(RuntimeException.class, err -> backupMessageNode());
        ...
        public void good_old_polling() {
                ...
                Flux<String> alerts = nodeAlerts()
                                .repeatWhen(el -> el.delayElements(Duration.ofSeconds(1)))
                                .repeat();
                // nodeAlerts();
